...
t47 = abs(t46)
t50 = lax_cond(0.0e0 < t46, 0.50e-12, -0.50e-12)
t51 = lax_cond(t47 < 0.50e-12, t50, t46)
t52 = br89_x(t51)
...
t81 = t74 ** 2
t83 = t76 ** 2
t94 = lax_cond(r0 <= p_a_dens_threshold, 0, -t22 * t23 * t29 * t54 * (0.1e1 - t55 * (0.1e1 + t52 / 0.2e1)) / t52 * (0.1e1 + params_a_at * (t70 / t71 - 0.2e1 * t74 * t70 / t76 / t71 + t81 * t70 / t83 / t71)) / 0.4e1)
t96 = lax_cond(t6, t11, -t13)
t97 = lax_cond(t10, t7, t96)
t98 = 0.1e1 + t97
t100 = t98 ** (0.1e1 / 0.3e1)
t102 = lax_cond(t98 <= p_a_zeta_threshold, t19, t100 * t98)
t105 = r1 ** (0.1e1 / 0.3e1)
t106 = t105 ** 2
t108 = 0.1e1 / t106 / r1
t115 = r1 ** 2
...
t121 = abs(t120)
t124 = lax_cond(0.0e0 < t120, 0.50e-12, -0.50e-12)
t125 = lax_cond(t121 < 0.50e-12, t124, t120)
t126 = br89_x(t125)
...
t148 = t141 ** 2
t150 = t143 ** 2
t161 = lax_cond(r1 <= p_a_dens_threshold, 0, -t102 * t23 * t29 * t128 * (0.1e1 - t129 * (0.1e1 + t126 / 0.2e1)) / t126 * (0.1e1 + params_a_at * (t137 / t138 - 0.2e1 * t141 * t137 / t143 / t138 + t148 * t137 / t150 / t138)) / 0.4e1)
res = t94 + t161
