...
t72 = lax_cond(r0 <= p_a_dens_threshold, 0, 0.3e1 / 0.20e2 * t6 * t29 * t31 * t68)
t74 = lax_cond(t11, t16, -t18)
t75 = lax_cond(t15, t12, t74)
t76 = 0.1e1 + t75
t78 = t76 ** (0.1e1 / 0.3e1)
t79 = t78 ** 2
t81 = lax_cond(t76 <= p_a_zeta_threshold, t25, t79 * t76)
t83 = r1 ** 2
t84 = r1 ** (0.1e1 / 0.3e1)
t85 = t84 ** 2
t91 = s2 ** 2
...
t110 = lax_cond(r1 <= p_a_dens_threshold, 0, 0.3e1 / 0.20e2 * t6 * t81 * t31 * t106)
res = t72 + t110
