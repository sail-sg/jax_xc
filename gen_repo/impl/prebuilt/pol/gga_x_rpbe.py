...
t53 = lax_cond(r0 <= p_a_dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t26 * t27 * (0.1e1 + params_a_rpbe_kappa * (0.1e1 - t46)))
...
t79 = lax_cond(r1 <= p_a_dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t61 * t27 * (0.1e1 + params_a_rpbe_kappa * (0.1e1 - t72)))
res = t53 + t79
