...
t101 = lax_cond(r0 <= p_a_dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t26 * t28 * t93 / (0.1e1 + 0.41666666666666666666e-9 * t41))
t103 = lax_cond(t10, t15, -t17)
t104 = lax_cond(t14, t11, t103)
t105 = 0.1e1 + t104
t107 = t105 ** (0.1e1 / 0.3e1)
t109 = lax_cond(t105 <= p_a_zeta_threshold, t23, t107 * t105)
t111 = r1 ** 2
t112 = r1 ** (0.1e1 / 0.3e1)
t113 = t112 ** 2
...
t162 = lax_cond(r1 <= p_a_dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t109 * t28 * t154 / (0.1e1 + 0.41666666666666666666e-9 * t117))
res = t101 + t162
