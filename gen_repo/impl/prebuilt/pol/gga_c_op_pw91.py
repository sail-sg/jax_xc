...
t109 = lax_cond(t31 * t2 / 0.2e1 <= p_a_dens_threshold, 0, t42 * t43 / t51 / (0.1e1 + ((0.2743e0 - 0.1508e0 * t68) * t54 * t58 * s0 * t64 / 0.24e2 - t87) / (0.1e1 + 0.16370833333333333333e-1 * t90 * t94 * t97 + t87)) / 0.9e1)
...
t164 = lax_cond(t45 * t2 / 0.2e1 <= p_a_dens_threshold, 0, t42 * t43 / t118 / (0.1e1 + ((0.2743e0 - 0.1508e0 * t129) * t54 * t58 * s2 * t125 / 0.24e2 - t144) / (0.1e1 + 0.16370833333333333333e-1 * t90 * t149 * t152 + t144)) / 0.9e1)
t165 = t109 + t164
t167 = lax_cond(t165 == 0.0e0, DBL_EPSILON, t165)
t171 = t167 ** 2
t172 = t171 ** 2
res = lax_cond(t11, 0, -0.25000000000000000000e0 * (0.1e1 - t20) * t2 * (0.360663084e1 / t167 + 0.5764e0) / (0.315815266717518096e2 / t172 + 0.150327320916243744e2 / t171 / t167 + 0.1788764629788e1 / t171))
