...
t55 = lax_cond(r0 <= p_a_dens_threshold, 0, 0.3e1 / 0.20e2 * t6 * t29 * t31 * t51)
t57 = lax_cond(t11, t16, -t18)
t58 = lax_cond(t15, t12, t57)
t59 = 0.1e1 + t58
t61 = t59 ** (0.1e1 / 0.3e1)
t62 = t61 ** 2
t64 = lax_cond(t59 <= p_a_zeta_threshold, t25, t62 * t59)
t67 = r1 ** 2
t68 = r1 ** (0.1e1 / 0.3e1)
t69 = t68 ** 2
t76 = (0.1e1 + t36 * t40 * s2 / t69 / t67 / 0.24e2) ** (-params_a_p)
t80 = lax_cond(r1 <= p_a_dens_threshold, 0, 0.3e1 / 0.20e2 * t6 * t64 * t31 * t76)
res = t55 + t80
