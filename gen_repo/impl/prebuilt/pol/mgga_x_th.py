...
t42 = 4 ** (0.1e1 / 0.3e1)
t43 = 0.1e1 / t40 * t42
t47 = lax_cond(r0 <= p_a_dens_threshold, 0, -0.27e2 / 0.80e2 * t3 * t24 * t26 * t27 * t31 * r0 * (0.1e1 + 0.7e1 / 0.216e3 * s0 / r0 * t27) * t43)
...
t60 = r1 ** (0.1e1 / 0.3e1)
t61 = t60 ** 2
t72 = lax_cond(r1 <= p_a_dens_threshold, 0, -0.27e2 / 0.80e2 * t3 * t55 * t26 * t57 * t61 * r1 * (0.1e1 + 0.7e1 / 0.216e3 * s2 / r1 * t57) * t43)
res = t47 + t72
