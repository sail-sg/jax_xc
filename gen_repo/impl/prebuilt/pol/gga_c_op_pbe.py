...
t61 = r0 ** (0.1e1 / 0.3e1)
t62 = t61 ** 2
t76 = lax_cond(t31 * t2 / 0.2e1 <= p_a_dens_threshold, 0, t42 * t43 / t51 / (0.18040e1 - 0.64641600e0 / (0.8040e0 + 0.91464571985215458336e-2 * t59 * s0 / t62 / t60)) / 0.9e1)
...
t89 = r1 ** (0.1e1 / 0.3e1)
t90 = t89 ** 2
t104 = lax_cond(t45 * t2 / 0.2e1 <= p_a_dens_threshold, 0, t42 * t43 / t85 / (0.18040e1 - 0.64641600e0 / (0.8040e0 + 0.91464571985215458336e-2 * t59 * s2 / t90 / t88)) / 0.9e1)
t105 = t76 + t104
t107 = lax_cond(t105 == 0.0e0, DBL_EPSILON, t105)
t111 = t107 ** 2
t112 = t111 ** 2
res = lax_cond(t11, 0, -0.25000000000000000000e0 * (0.1e1 - t20) * t2 * (0.361925846e1 / t107 + 0.5764e0) / (0.320261508740743441e2 / t112 + 0.151911844324290596e2 / t111 / t107 + 0.1801312286343e1 / t111))
