...
t147 = lax_cond(r0 <= p_a_dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t26 * t27 * (0.1e1 + params_a_kappa * (0.1e1 - params_a_kappa / (params_a_kappa + ((0.10e2 / 0.81e2 + params_a_c * t39 / t50) * t54 * t65 / 0.24e2 + 0.146e3 / 0.2025e4 * t91 - 0.73e2 / 0.97200e5 * t90 * t106 + 0.25e2 / 0.944784e6 * t110 * t96 * t41 * t101 + t115 * t41 * t43 * t46 / 0.720e3 + t120 * t122 * t41 * s0 / t125 / 0.2304e4) / t135))))
t149 = lax_cond(t10, t15, -t17)
t150 = lax_cond(t14, t11, t149)
t151 = 0.1e1 + t150
t153 = t151 ** (0.1e1 / 0.3e1)
t155 = lax_cond(t151 <= p_a_zeta_threshold, t23, t153 * t151)
t157 = 0.1e1 / r1
t159 = 0.1e1 / tau1
...
t258 = lax_cond(r1 <= p_a_dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t155 * t27 * (0.1e1 + params_a_kappa * (0.1e1 - params_a_kappa / (params_a_kappa + ((0.10e2 / 0.81e2 + params_a_c * t167 / t178) * t54 * t188 / 0.24e2 + 0.146e3 / 0.2025e4 * t213 - 0.73e2 / 0.97200e5 * t212 * t224 + 0.25e2 / 0.944784e6 * t110 * t96 * t169 * t219 + t115 * t169 * t171 * t174 / 0.720e3 + t120 * t122 * t169 * s2 / t237 / 0.2304e4) / t246))))
res = t147 + t258
