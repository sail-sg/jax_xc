...
t83 = abs(t82)
t86 = lax_cond(0.0e0 < t82, 0.50e-12, -0.50e-12)
t87 = lax_cond(t83 < 0.50e-12, t86, t82)
t88 = br89_x(t87)
t90 = math.exp(t88 / 0.3e1)
t92 = math.exp(-t88)
t102 = lax_cond(r0 / 0.2e1 <= p_a_dens_threshold, 0, -t14 * t15 / t18 * t21 * t90 * (0.1e1 - t92 * (0.1e1 + t88 / 0.2e1)) / t88 / 0.4e1)
res = 0.2e1 * t102
