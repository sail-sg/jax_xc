...
t76 = lax_cond(r0 / 0.2e1 <= p_a_dens_threshold, 0, -0.3e1 / 0.8e1 * t3 / t4 * t18 * t19 * ((0.1e1 + 0.39310185185185185185e-2 * t35) / (0.1e1 + t47) + 0.37812500000000000000e-4 * t42 * t45 * t65 / (0.115e1 + t47)))
res = 0.2e1 * t76
