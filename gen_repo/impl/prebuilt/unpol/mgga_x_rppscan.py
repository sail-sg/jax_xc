...
t118 = lax_cond(t79 <= 0.25e1, 0.1e1 - 0.667e0 * t97 - 0.4445555e0 * t99 - 0.663086601049e0 * t101 + 0.1451297044490e1 * t103 - 0.887998041597e0 * t103 * t97 + 0.234528941479e0 * t103 * t99 - 0.23185843322e-1 * t103 * t101, -params_a_d * t116)
t124 = math.sqrt(0.3e1)
t127 = math.sqrt(s0)
t133 = math.sqrt(t40 / t23 * t127 * t27 / t20 / r0)
t137 = math.exp(-0.98958000000000000000e1 * t124 / t133)
t142 = lax_cond(r0 / 0.2e1 <= p_a_dens_threshold, 0, -0.3e1 / 0.8e1 * t3 / t4 * t18 * t20 * ((0.1e1 + params_a_k1 * (0.1e1 - params_a_k1 / (params_a_k1 + 0.5e1 / 0.972e3 * t21 * t25 * t34 + t39 * t40 / t23 / t22 * t45 * t27 / t20 / t47 / r0 * t55 / 0.288e3 + t88))) * (0.1e1 - t118) + 0.1174e1 * t118) * (0.1e1 - t137))
res = 0.2e1 * t142
