...
t49 = lax_cond(0.0e0 < 0.9999999999e0 - t45, 0.1e1 - t45, 0.1e-9)
...
t74 = abs(t73)
t79 = t27 * t73 / 0.6e1
t81 = lax_cond(0.0e0 < t79, 0.50e-12, -0.50e-12)
t82 = lax_cond(t27 * t74 / 0.6e1 < 0.50e-12, t81, t79)
t83 = mbrxc_x(t82)
t85 = math.exp(t83 / 0.3e1)
t87 = math.exp(-t83)
t88 = t83 ** 2
t96 = (0.1e1 + t83) ** (0.1e1 / 0.3e1)
t102 = lax_cond(r0 / 0.2e1 <= p_a_dens_threshold, 0, -t14 * t15 * t17 / t19 * t23 * t85 * (0.8e1 - t87 * (t88 + 0.5e1 * t83 + 0.8e1)) / t83 / t96 / 0.64e2)
res = 0.2e1 * t102
