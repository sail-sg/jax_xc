...
t78 = 0.1e1 / t77
t88 = jnp.where(0.0e0 < t76, t76, -t76)
t90 = t76 ** 2
t92 = t90 ** 2
t96 = jnp.where(-t78 < t76, t76, -t78)
t97 = t96 ** 2
t99 = math.sqrt(0.1e1 + t97)
t102 = jnp.where(t88 < t77, 0.1e1 - t68 + t75 + params_a_b2 + t90 / 0.2e1 - t92 / 0.8e1, 0.1e1 / (t96 + t99))
t103 = jnp.where(t76 < -t78, -0.4e1 * t67 + 0.4e1 * t74 + 0.2e1 * params_a_b2 - 0.1e1 / t76 / 0.2e1, t102)
...
t135 = jnp.where(r0 / 0.2e1 <= p_a_dens_threshold, 0, -0.3e1 / 0.8e1 * t3 / t4 * t18 * t19 * t131)
res = 0.2e1 * t135
