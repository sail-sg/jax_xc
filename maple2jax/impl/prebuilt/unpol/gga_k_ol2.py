...
t34 = math.sqrt(s0)
t37 = 0.1e1 / t22 / r0
t50 = jnp.where(r0 / 0.2e1 <= p_a_dens_threshold, 0, 0.3e1 / 0.20e2 * t4 * t5 * math.pi * t21 * t23 * (params_a_aa + 0.13888888888888888889e-1 * params_a_bb * s0 * t27 / t23 / t28 + params_a_cc * t34 * t26 * t37 / (0.4e1 * t34 * t26 * t37 + t26)))
res = 0.2e1 * t50
