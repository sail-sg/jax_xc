...
t43 = abs(t42)
t46 = jnp.where(0.0e0 < t42, 0.50e-12, -0.50e-12)
t47 = jnp.where(t43 < 0.50e-12, t46, t42)
t48 = br89_x(t47)
...
t78 = t71 ** 2
t80 = t73 ** 2
t91 = jnp.where(r0 / 0.2e1 <= p_a_dens_threshold, 0, -t14 * t15 / t18 * t20 * t50 * (0.1e1 - t51 * (0.1e1 + t48 / 0.2e1)) / t48 * (0.1e1 + params_a_at * (t67 / t68 - 0.2e1 * t71 * t67 / t73 / t68 + t78 * t67 / t80 / t68)) / 0.4e1)
res = 0.2e1 * t91
