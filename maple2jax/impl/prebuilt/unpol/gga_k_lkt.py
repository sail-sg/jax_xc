...
t40 = jnp.where(t38 < 0.200e3, t38, 200)
t42 = math.cosh(params_a_a * t40)
t44 = t28 ** 2
t47 = t32 ** 2
t49 = r0 ** 2
t59 = jnp.where(r0 / 0.2e1 <= p_a_dens_threshold, 0, 0.3e1 / 0.20e2 * t4 * t5 * math.pi * t21 * t23 * (0.1e1 / t42 + 0.5e1 / 0.72e2 * t25 / t44 * s0 * t47 / t23 / t49))
res = 0.2e1 * t59
