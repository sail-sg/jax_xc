...
t59 = jnp.where(r0 / 0.2e1 <= p_a_dens_threshold, 0, 0.3e1 / 0.20e2 * t4 * t5 * math.pi * t21 * t23 * (0.10e1 + 0.2e1 / 0.9e1 * params_a_beta * t4 / t27 * t29 * s0 * t33 / t23 / t35 / (0.10e1 + params_a_gamma * params_a_beta * t39 * t32 * t42 * t46)))
res = 0.2e1 * t59
