...
t145 = jnp.where(t106 <= 0.25e1, 0.1e1 - 0.667e0 * t124 - 0.4445555e0 * t126 - 0.663086601049e0 * t128 + 0.1451297044490e1 * t130 - 0.887998041597e0 * t130 * t124 + 0.234528941479e0 * t130 * t126 - 0.23185843322e-1 * t130 * t128, -params_a_d * t143)
t151 = math.sqrt(0.3e1)
t154 = math.sqrt(s0)
t160 = math.sqrt(t40 / t23 * t154 * t27 / t20 / r0)
t164 = math.exp(-0.98958000000000000000e1 * t151 / t160)
t169 = jnp.where(r0 / 0.2e1 <= p_a_dens_threshold, 0, -0.3e1 / 0.8e1 * t3 / t4 * t18 * t20 * ((0.1e1 + params_a_k1 * (0.1e1 - params_a_k1 / (params_a_k1 + 0.5e1 / 0.972e3 * t21 * t25 * t34 + t39 * t40 / t23 / t22 * t45 * t27 / t20 / t48 * t55 / 0.288e3 + t115))) * (0.1e1 - t145) + 0.1174e1 * t145) * (0.1e1 - t164))
res = 0.2e1 * t169
