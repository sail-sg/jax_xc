...
t54 = abs(t53)
t57 = jnp.where(0.0e0 < t53, 0.50e-12, -0.50e-12)
t58 = jnp.where(t54 < 0.50e-12, t57, t53)
t59 = mbrxc_x(t58)
t61 = math.exp(t59 / 0.3e1)
t63 = math.exp(-t59)
t64 = t59 ** 2
t72 = (0.1e1 + t59) ** (0.1e1 / 0.3e1)
t78 = jnp.where(r0 / 0.2e1 <= p_a_dens_threshold, 0, -t14 * t15 * t17 / t19 * t23 * t61 * (0.8e1 - t63 * (t64 + 0.5e1 * t59 + 0.8e1)) / t59 / t72 / 0.64e2)
res = 0.2e1 * t78
