...
t38 = jnp.where(t13 * r0 / 0.2e1 <= p_a_dens_threshold, 0, t22 * t25 / t33 / 0.9e1)
t43 = jnp.where(t26, t7, -t9)
t44 = jnp.where(t28, t6, t43)
t47 = ((0.1e1 + t44) * r0) ** (0.1e1 / 0.3e1)
t52 = jnp.where(t27 * r0 / 0.2e1 <= p_a_dens_threshold, 0, t22 * t25 / t47 / 0.9e1)
t53 = t38 + t52
t55 = jnp.where(t53 == 0.0e0, DBL_EPSILON, t53)
t59 = t55 ** 2
t60 = t59 ** 2
res = jnp.where(t5, 0, -0.25000000000000000000e0 * (0.1e1 - t10) * r0 * (0.390299956e1 / t55 + 0.5764e0) / (0.433132090567376656e2 / t60 + 0.190514637481962976e2 / t59 / t55 + 0.2094820520028e1 / t59))
