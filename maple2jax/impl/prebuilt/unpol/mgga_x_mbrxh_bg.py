...
t52 = abs(t51)
t55 = jnp.where(0.0e0 < t51, 0.50e-12, -0.50e-12)
t56 = jnp.where(t52 < 0.50e-12, t55, t51)
t57 = br89_x(t56)
t59 = math.exp(t57 / 0.3e1)
t61 = math.exp(-t57)
t71 = jnp.where(r0 / 0.2e1 <= p_a_dens_threshold, 0, -t14 * t15 / t18 * t21 * t59 * (0.1e1 - t61 * (0.1e1 + t57 / 0.2e1)) / t57 / 0.4e1)
res = 0.2e1 * t71
