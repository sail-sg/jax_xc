...
t34 = r0 ** 2
t37 = s0 * t32 / t23 / t34
t44 = math.exp(-params_a_pg_mu * t25 * t29 * t37 / 0.24e2)
t49 = jnp.where(r0 / 0.2e1 <= p_a_dens_threshold, 0, 0.3e1 / 0.20e2 * t4 * t5 * math.pi * t21 * t23 * (0.5e1 / 0.72e2 * t25 * t29 * t37 + t44))
res = 0.2e1 * t49
