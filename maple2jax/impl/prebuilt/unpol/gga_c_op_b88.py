...
t63 = jnp.where(t13 * r0 / 0.2e1 <= p_a_dens_threshold, 0, t24 * t25 / t33 * t59 / 0.9e1)
t68 = jnp.where(t26, t7, -t9)
t69 = jnp.where(t28, t6, t68)
t72 = ((0.1e1 + t69) * r0) ** (0.1e1 / 0.3e1)
t78 = jnp.where(t27 * r0 / 0.2e1 <= p_a_dens_threshold, 0, t24 * t25 / t72 * t59 / 0.9e1)
t79 = t63 + t78
t81 = jnp.where(t79 == 0.0e0, DBL_EPSILON, t79)
t85 = t81 ** 2
t86 = t85 ** 2
res = jnp.where(t5, 0, -0.25000000000000000000e0 * (0.1e1 - t10) * r0 * (0.360115380e1 / t81 + 0.5764e0) / (0.313901240307210000e2 / t86 + 0.149643497914092000e2 / t85 / t81 + 0.1783335908700e1 / t85))
