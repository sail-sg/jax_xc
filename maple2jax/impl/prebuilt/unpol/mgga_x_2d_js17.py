...
t49 = t37 ** (0.1e1 / 0.5e1)
t57 = lax_cond(r0 / 0.2e1 <= p_a_dens_threshold, 0, -0.2e1 / 0.3e1 / t3 * t16 * t18 * t19 * (0.1e1 / t38 + 0.2e1 / 0.5e1 * (0.1e1 + 0.17554285714285714286e0 * t26 + (-0.1544000000000000000e0 * tau0 / t23 - 0.36912000000000000000e1 * math.pi) * t21 / 0.4e1) / t49))
res = 0.2e1 * t57
