...
t96 = jnp.where(t13 * r0 / 0.2e1 <= p_a_dens_threshold, 0, t24 * t25 / t33 * t92 / 0.9e1)
t101 = jnp.where(t26, t7, -t9)
t102 = jnp.where(t28, t6, t101)
t105 = ((0.1e1 + t102) * r0) ** (0.1e1 / 0.3e1)
t111 = jnp.where(t27 * r0 / 0.2e1 <= p_a_dens_threshold, 0, t24 * t25 / t105 * t92 / 0.9e1)
t112 = t96 + t111
t114 = jnp.where(t112 == 0.0e0, DBL_EPSILON, t112)
t118 = t114 ** 2
t119 = t118 ** 2
res = jnp.where(t5, 0, -0.25000000000000000000e0 * (0.1e1 - t10) * r0 * (0.360663084e1 / t114 + 0.5764e0) / (0.315815266717518096e2 / t119 + 0.150327320916243744e2 / t118 / t114 + 0.1788764629788e1 / t118))
