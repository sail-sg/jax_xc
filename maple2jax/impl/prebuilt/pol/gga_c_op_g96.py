...
t58 = t54 / t55 / r0
t59 = math.sqrt(t58)
t69 = jnp.where(t31 * t2 / 0.2e1 <= p_a_dens_threshold, 0, t42 * t43 / t51 / (0.1e1 + 0.2e1 / 0.1233e4 * t40 * t41 * t59 * t58) / 0.9e1)
...
t85 = t81 / t82 / r1
t86 = math.sqrt(t85)
t96 = jnp.where(t45 * t2 / 0.2e1 <= p_a_dens_threshold, 0, t42 * t43 / t78 / (0.1e1 + 0.2e1 / 0.1233e4 * t40 * t41 * t86 * t85) / 0.9e1)
t97 = t69 + t96
t99 = jnp.where(t97 == 0.0e0, DBL_EPSILON, t97)
t103 = t99 ** 2
t104 = t103 ** 2
res = jnp.where(t11, 0, -0.25000000000000000000e0 * (0.1e1 - t20) * t2 * (0.359628532e1 / t99 + 0.5764e0) / (0.312207199195441936e2 / t104 + 0.149037398922132448e2 / t103 / t99 + 0.1778517305052e1 / t103))
