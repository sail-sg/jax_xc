...
t63 = t60 / t55 / r0
t64 = math.asinh(t63)
t77 = jnp.where(t31 * t2 / 0.2e1 <= p_a_dens_threshold, 0, t42 * t43 / t51 / (0.1e1 + 0.93333333333333333332e-3 * t42 * s0 / t56 / t54 / (0.1e1 + 0.2520e-1 * t63 * t64)) / 0.9e1)
...
t98 = t95 / t90 / r1
t99 = math.asinh(t98)
t112 = jnp.where(t45 * t2 / 0.2e1 <= p_a_dens_threshold, 0, t42 * t43 / t86 / (0.1e1 + 0.93333333333333333332e-3 * t42 * s2 / t91 / t89 / (0.1e1 + 0.2520e-1 * t98 * t99)) / 0.9e1)
t113 = t77 + t112
t115 = jnp.where(t113 == 0.0e0, DBL_EPSILON, t113)
t119 = t115 ** 2
t120 = t119 ** 2
res = jnp.where(t11, 0, -0.25000000000000000000e0 * (0.1e1 - t20) * t2 * (0.360115380e1 / t115 + 0.5764e0) / (0.313901240307210000e2 / t120 + 0.149643497914092000e2 / t119 / t115 + 0.1783335908700e1 / t119))
