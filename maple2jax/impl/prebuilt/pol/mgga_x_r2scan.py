...
t116 = jnp.where(t84 <= 0.25e1, 0.1e1 - 0.667e0 * t95 - 0.4445555e0 * t97 - 0.663086601049e0 * t99 + 0.1451297044490e1 * t101 - 0.887998041597e0 * t101 * t95 + 0.234528941479e0 * t101 * t97 - 0.23185843322e-1 * t101 * t99, -params_a_d * t114)
t117 = jnp.where(t84 <= 0.0e0, t92, t116)
t122 = math.sqrt(0.3e1)
t124 = t32 / t34
t125 = math.sqrt(s0)
t130 = math.sqrt(t124 * t125 / t42 / r0)
t134 = math.exp(-0.98958000000000000000e1 * t122 / t130)
t139 = jnp.where(r0 <= p_a_dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t26 * t28 * (0.1e1 + t70 + t117 * (0.174e0 - t70)) * (0.1e1 - t134))
t141 = jnp.where(t10, t15, -t17)
t142 = jnp.where(t14, t11, t141)
t143 = 0.1e1 + t142
t145 = t143 ** (0.1e1 / 0.3e1)
t147 = jnp.where(t143 <= p_a_zeta_threshold, t23, t145 * t143)
t149 = s2 ** 2
t150 = r1 ** 2
t151 = t150 ** 2
t153 = r1 ** (0.1e1 / 0.3e1)
...
t191 = jnp.where(0.0e0 < t188, 0, t188)
...
t220 = jnp.where(t188 <= 0.25e1, 0.1e1 - 0.667e0 * t199 - 0.4445555e0 * t201 - 0.663086601049e0 * t203 + 0.1451297044490e1 * t205 - 0.887998041597e0 * t205 * t199 + 0.234528941479e0 * t205 * t201 - 0.23185843322e-1 * t205 * t203, -params_a_d * t218)
t221 = jnp.where(t188 <= 0.0e0, t196, t220)
t226 = math.sqrt(s2)
t231 = math.sqrt(t124 * t226 / t153 / r1)
t235 = math.exp(-0.98958000000000000000e1 * t122 / t231)
t240 = jnp.where(r1 <= p_a_dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t147 * t28 * (0.1e1 + t176 + t221 * (0.174e0 - t176)) * (0.1e1 - t235))
res = t139 + t240
