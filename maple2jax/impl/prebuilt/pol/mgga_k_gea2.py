...
t40 = r0 ** (0.1e1 / 0.3e1)
t41 = t40 ** 2
t56 = jnp.where(r0 <= p_a_dens_threshold, 0, 0.3e1 / 0.20e2 * t6 * t29 * t31 * (0.1e1 + 0.5e1 / 0.648e3 * t38 * s0 / t41 / t39 + 0.5e1 / 0.54e2 * t38 * l0 / t41 / r0))
...
t68 = r1 ** (0.1e1 / 0.3e1)
t69 = t68 ** 2
t84 = jnp.where(r1 <= p_a_dens_threshold, 0, 0.3e1 / 0.20e2 * t6 * t65 * t31 * (0.1e1 + 0.5e1 / 0.648e3 * t38 * s2 / t69 / t67 + 0.5e1 / 0.54e2 * t38 * l1 / t69 / r1))
res = t56 + t84
