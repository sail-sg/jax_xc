...
t44 = 0.1e1 / t35 / r0
t45 = 2 ** (0.1e1 / 0.3e1)
t56 = lax_cond(r0 <= p_a_dens_threshold, 0, 0.3e1 / 0.20e2 * t6 * t29 * t31 * (params_a_aa + 0.13888888888888888889e-1 * params_a_bb * s0 / t36 / t34 + params_a_cc * t41 * t44 / (0.4e1 * t41 * t44 + t45)))
...
t75 = math.sqrt(s2)
t78 = 0.1e1 / t69 / r1
t89 = lax_cond(r1 <= p_a_dens_threshold, 0, 0.3e1 / 0.20e2 * t6 * t65 * t31 * (params_a_aa + 0.13888888888888888889e-1 * params_a_bb * s2 / t70 / t68 + params_a_cc * t75 * t78 / (0.4e1 * t75 * t78 + t45)))
res = t56 + t89
