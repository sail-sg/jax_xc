...
t56 = lax_cond(t31 * t2 / 0.2e1 <= p_a_dens_threshold, 0, t40 * t43 / t51 / 0.9e1)
t61 = lax_cond(t44, t17, -t30)
t62 = lax_cond(t46, t14, t61)
t65 = ((0.1e1 + t62) * t2) ** (0.1e1 / 0.3e1)
t70 = lax_cond(t45 * t2 / 0.2e1 <= p_a_dens_threshold, 0, t40 * t43 / t65 / 0.9e1)
t71 = t56 + t70
t73 = lax_cond(t71 == 0.0e0, DBL_EPSILON, t71)
t77 = t73 ** 2
t78 = t77 ** 2
res = lax_cond(t11, 0, -0.25000000000000000000e0 * (0.1e1 - t20) * t2 * (0.390299956e1 / t73 + 0.5764e0) / (0.433132090567376656e2 / t78 + 0.190514637481962976e2 / t77 / t73 + 0.2094820520028e1 / t77))
