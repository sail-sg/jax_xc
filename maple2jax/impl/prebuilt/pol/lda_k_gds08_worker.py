...
t27 = t25 ** 2
t32 = jnp.where(r0 <= p_a_dens_threshold, 0, (0.1e1 + t13) * (params_a_B * t25 + params_a_C * t27 + params_a_A) / 0.2e1)
...
t43 = t41 ** 2
t48 = jnp.where(r1 <= p_a_dens_threshold, 0, (0.1e1 + t35) * (params_a_B * t41 + params_a_C * t43 + params_a_A) / 0.2e1)
res = t32 + t48
