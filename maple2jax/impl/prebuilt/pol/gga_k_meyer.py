...
t79 = jnp.where(r0 <= p_a_dens_threshold, 0, 0.3e1 / 0.20e2 * t6 * t29 * t31 * (0.1e1 + 0.20e2 * (0.1e1 / 0.2e1 - t69) / (0.1e1 / 0.2e1 + t69)))
t81 = jnp.where(t11, t16, -t18)
t82 = jnp.where(t15, t12, t81)
t83 = 0.1e1 + t82
t85 = t83 ** (0.1e1 / 0.3e1)
t86 = t85 ** 2
t88 = jnp.where(t83 <= p_a_zeta_threshold, t25, t86 * t83)
t90 = r1 ** 2
t91 = r1 ** (0.1e1 / 0.3e1)
t92 = t91 ** 2
t99 = math.sqrt(s2)
...
t127 = jnp.where(r1 <= p_a_dens_threshold, 0, 0.3e1 / 0.20e2 * t6 * t88 * t31 * (0.1e1 + 0.20e2 * (0.1e1 / 0.2e1 - t117) / (0.1e1 / 0.2e1 + t117)))
res = t79 + t127
