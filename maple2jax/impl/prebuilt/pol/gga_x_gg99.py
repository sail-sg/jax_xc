...
t26 = t22 ** (0.1e1 / 0.3e1)
t28 = jnp.where(t22 <= p_a_zeta_threshold, t25, t26 * t22)
t29 = t8 ** (0.1e1 / 0.3e1)
t32 = math.pi ** 2
t33 = math.sqrt(s0)
t34 = r0 ** (0.1e1 / 0.3e1)
...
t117 = 0.1e1 / t116
t123 = jnp.where(r0 <= p_a_dens_threshold, 0, -t7 * t28 * t29 * (-0.12e2 * t100 * t104 + 0.12e2 * t107 + t32) / t100 / t114 * t117 * t38 / 0.24e2)
t125 = jnp.where(t12, t17, -t19)
t126 = jnp.where(t16, t13, t125)
t127 = 0.1e1 + t126
t129 = t127 ** (0.1e1 / 0.3e1)
t131 = jnp.where(t127 <= p_a_zeta_threshold, t25, t129 * t127)
t134 = math.sqrt(s2)
t135 = r1 ** (0.1e1 / 0.3e1)
t138 = t134 / t135 / r1
...
t194 = t193 ** 2
t201 = jnp.where(r1 <= p_a_dens_threshold, 0, -t7 * t131 * t29 * (-0.12e2 * t180 * t184 + 0.12e2 * t187 + t32) / t180 / t194 * t117 * t38 / 0.24e2)
res = t123 + t201
