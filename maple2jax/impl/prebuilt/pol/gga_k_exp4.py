...
t67 = jnp.where(r0 <= p_a_dens_threshold, 0, 0.3e1 / 0.20e2 * t6 * t29 * t31 * (0.20788e1 - 0.8524e0 * t47 - 0.12264e1 * t61))
t69 = jnp.where(t11, t16, -t18)
t70 = jnp.where(t15, t12, t69)
t71 = 0.1e1 + t70
t73 = t71 ** (0.1e1 / 0.3e1)
t74 = t73 ** 2
t76 = jnp.where(t71 <= p_a_zeta_threshold, t25, t74 * t71)
t78 = r1 ** 2
t79 = r1 ** (0.1e1 / 0.3e1)
t80 = t79 ** 2
...
t102 = jnp.where(r1 <= p_a_dens_threshold, 0, 0.3e1 / 0.20e2 * t6 * t76 * t31 * (0.20788e1 - 0.8524e0 * t86 - 0.12264e1 * t96))
res = t67 + t102
