...
t166 = jnp.where(r0 <= p_a_dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t26 * t27 * ((0.18040e1 - 0.64641600e0 / (0.8040e0 + 0.91462500000000000000e-2 * t41)) * t120 + (0.1552e1 - 0.552e0 * t123) * t160))
t168 = jnp.where(t10, t15, -t17)
t169 = jnp.where(t14, t11, t168)
t170 = 0.1e1 + t169
t172 = t170 ** (0.1e1 / 0.3e1)
t174 = jnp.where(t170 <= p_a_zeta_threshold, t23, t172 * t170)
t176 = r1 ** 2
t177 = r1 ** (0.1e1 / 0.3e1)
t178 = t177 ** 2
...
t280 = jnp.where(r1 <= p_a_dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t174 * t27 * ((0.18040e1 - 0.64641600e0 / (0.8040e0 + 0.91462500000000000000e-2 * t182)) * t246 + (0.1552e1 - 0.552e0 * t249) * t274))
res = t166 + t280
