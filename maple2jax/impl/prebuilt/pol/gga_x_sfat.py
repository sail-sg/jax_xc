...
t148 = jnp.where(r0 <= p_a_dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t26 * t28 * t143 * t56)
t150 = jnp.where(t10, t15, -t17)
t151 = jnp.where(t14, t11, t150)
t152 = 0.1e1 + t151
t154 = t152 ** (0.1e1 / 0.3e1)
t156 = jnp.where(t152 <= p_a_zeta_threshold, t23, t154 * t152)
t158 = r1 ** 2
t159 = r1 ** (0.1e1 / 0.3e1)
t160 = t159 ** 2
t164 = math.sqrt(s2)
...
t267 = jnp.where(r1 <= p_a_dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t156 * t28 * t262 * t176)
res = t148 + t267
