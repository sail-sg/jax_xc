...
t90 = lax_cond(r0 <= p_a_dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t26 * t28 * (0.1e1 + params_a_k0 * (0.1e1 - 0.5e1 / 0.9e1 * t39 * t40 * t45) / t69) / t85)
t92 = lax_cond(t10, t15, -t17)
t93 = lax_cond(t14, t11, t92)
t94 = 0.1e1 + t93
t96 = t94 ** (0.1e1 / 0.3e1)
t98 = lax_cond(t94 <= p_a_zeta_threshold, t23, t96 * t94)
t100 = r1 ** (0.1e1 / 0.3e1)
t101 = t100 ** 2
t105 = r1 ** 2
...
t147 = lax_cond(r1 <= p_a_dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t98 * t28 * (0.1e1 + params_a_k0 * (0.1e1 - 0.5e1 / 0.9e1 * t110 * t40 * t45) / t127) / t142)
res = t90 + t147
