...
t123 = jnp.where(0.135e1 <= t74, 0.1e1 / t78 / 0.36e2 - 0.1e1 / t81 / 0.960e3 + 0.1e1 / t84 / 0.26880e5 - 0.1e1 / t87 / 0.829440e6 + 0.1e1 / t87 / t78 / 0.28385280e8 - 0.1e1 / t87 / t81 / 0.1073479680e10 + 0.1e1 / t87 / t84 / 0.44590694400e11 - 0.1e1 / t99 / 0.2021444812800e13, 0.1e1 - 0.8e1 / 0.3e1 * t103 * (t104 * t107 + 0.2e1 * t103 * (t112 - 0.3e1 / 0.2e1 - 0.2e1 * t109 * (t112 - 0.1e1))))
t129 = jnp.where(r0 <= p_a_dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t26 * t28 * t53 * (-p_a_cam_beta * t123 - p_a_cam_alpha + 0.1e1))
...
t224 = jnp.where(0.135e1 <= t176, 0.1e1 / t180 / 0.36e2 - 0.1e1 / t183 / 0.960e3 + 0.1e1 / t186 / 0.26880e5 - 0.1e1 / t189 / 0.829440e6 + 0.1e1 / t189 / t180 / 0.28385280e8 - 0.1e1 / t189 / t183 / 0.1073479680e10 + 0.1e1 / t189 / t186 / 0.44590694400e11 - 0.1e1 / t201 / 0.2021444812800e13, 0.1e1 - 0.8e1 / 0.3e1 * t205 * (t104 * t208 + 0.2e1 * t205 * (t213 - 0.3e1 / 0.2e1 - 0.2e1 * t210 * (t213 - 0.1e1))))
t230 = jnp.where(r1 <= p_a_dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t137 * t28 * t163 * (-p_a_cam_beta * t224 - p_a_cam_alpha + 0.1e1))
res = t129 + t230
