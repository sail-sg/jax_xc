...
t37 = t36 ** 2
t47 = lax_cond(r0 <= p_a_dens_threshold, 0, -0.2e1 / 0.3e1 * t3 * t24 * t28 * (0.1e1 + 0.12438750000000000000e-2 * t2 * s0 * t32 / t37 / t36))
t49 = lax_cond(t8, t13, -t15)
t50 = lax_cond(t12, t9, t49)
t51 = 0.1e1 + t50
t53 = math.sqrt(t51)
t55 = lax_cond(t51 <= p_a_zeta_threshold, t21, t53 * t51)
t58 = r1 ** 2
t60 = 0.1e1 / t58 / r1
t64 = (0.1e1 + 0.8323e-2 * s2 * t60) ** (0.1e1 / 0.4e1)
t65 = t64 ** 2
t75 = lax_cond(r1 <= p_a_dens_threshold, 0, -0.2e1 / 0.3e1 * t3 * t55 * t28 * (0.1e1 + 0.12438750000000000000e-2 * t2 * s2 * t60 / t65 / t64))
res = t47 + t75
