...
t56 = abs(t55)
t59 = lax_cond(0.0e0 < t55, 0.50e-12, -0.50e-12)
t60 = lax_cond(t56 < 0.50e-12, t59, t55)
t61 = br89_x(t60)
t63 = math.exp(t61 / 0.3e1)
t65 = math.exp(-t61)
t75 = lax_cond(r0 <= p_a_dens_threshold, 0, -t22 * t23 * t27 * t29 * t63 * (0.1e1 - t65 * (0.1e1 + t61 / 0.2e1)) / t61 / 0.4e1)
t77 = lax_cond(t6, t11, -t13)
t78 = lax_cond(t10, t7, t77)
t79 = 0.1e1 + t78
t81 = t79 ** (0.1e1 / 0.3e1)
t83 = lax_cond(t79 <= p_a_zeta_threshold, t19, t81 * t79)
t86 = r1 ** (0.1e1 / 0.3e1)
t87 = t86 ** 2
t92 = r1 ** 2
t97 = s2 ** 2
...
t105 = abs(t104)
t108 = lax_cond(0.0e0 < t104, 0.50e-12, -0.50e-12)
t109 = lax_cond(t105 < 0.50e-12, t108, t104)
t110 = br89_x(t109)
t112 = math.exp(t110 / 0.3e1)
t114 = math.exp(-t110)
t124 = lax_cond(r1 <= p_a_dens_threshold, 0, -t83 * t23 * t27 * t29 * t112 * (0.1e1 - t114 * (0.1e1 + t110 / 0.2e1)) / t110 / 0.4e1)
res = t75 + t124
