...
t56 = 0.1e1 / t35 / t34
t57 = l0 ** 2
t69 = jnp.where(r0 <= p_a_dens_threshold, 0, 0.3e1 / 0.20e2 * t6 * t29 * t31 * (0.5e1 / 0.72e2 * t38 * s0 * t43 + t52 + t54 * t56 * t57 / t40 / t39 / r0 / 0.576e3))
t71 = jnp.where(t11, t16, -t18)
t72 = jnp.where(t15, t12, t71)
t73 = 0.1e1 + t72
t75 = t73 ** (0.1e1 / 0.3e1)
t76 = t75 ** 2
t78 = jnp.where(t73 <= p_a_zeta_threshold, t25, t76 * t73)
t80 = r1 ** 2
t81 = r1 ** (0.1e1 / 0.3e1)
t82 = t81 ** 2
t84 = 0.1e1 / t82 / t80
...
t93 = l1 ** 2
t105 = jnp.where(r1 <= p_a_dens_threshold, 0, 0.3e1 / 0.20e2 * t6 * t78 * t31 * (0.5e1 / 0.72e2 * t38 * s2 * t84 + t92 + t54 * t56 * t93 / t81 / t80 / r1 / 0.576e3))
res = t69 + t105
