...
t47 = jnp.where(t45 < 0.200e3, t45, 200)
t49 = math.cosh(params_a_a * t47)
t51 = t36 ** 2
t53 = t33 / t51
t54 = r0 ** 2
t55 = t40 ** 2
t65 = jnp.where(r0 <= p_a_dens_threshold, 0, 0.3e1 / 0.20e2 * t6 * t29 * t31 * (0.1e1 / t49 + 0.5e1 / 0.72e2 * t53 * s0 / t55 / t54))
t67 = jnp.where(t11, t16, -t18)
t68 = jnp.where(t15, t12, t67)
t69 = 0.1e1 + t68
t71 = t69 ** (0.1e1 / 0.3e1)
t72 = t71 ** 2
t74 = jnp.where(t69 <= p_a_zeta_threshold, t25, t72 * t69)
t76 = math.sqrt(s2)
t77 = r1 ** (0.1e1 / 0.3e1)
t82 = t38 * t76 / t77 / r1 / 0.12e2
t84 = jnp.where(t82 < 0.200e3, t82, 200)
t86 = math.cosh(params_a_a * t84)
t88 = r1 ** 2
t89 = t77 ** 2
t99 = jnp.where(r1 <= p_a_dens_threshold, 0, 0.3e1 / 0.20e2 * t6 * t74 * t31 * (0.1e1 / t86 + 0.5e1 / 0.72e2 * t53 * s2 / t89 / t88))
res = t65 + t99
