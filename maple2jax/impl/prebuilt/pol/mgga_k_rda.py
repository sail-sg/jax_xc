...
t107 = jnp.where(r0 <= p_a_dens_threshold, 0, 0.3e1 / 0.20e2 * t6 * t29 * t31 * (0.5e1 / 0.72e2 * t45 + params_a_A0 + params_a_A1 * t66 / t72 / 0.576e3 + params_a_A2 * t79 / t86 / 0.331776e6 + params_a_A3 * t97 / (params_a_beta3 * t97 + 0.1e1)))
...
t179 = jnp.where(r1 <= p_a_dens_threshold, 0, 0.3e1 / 0.20e2 * t6 * t116 * t31 * (0.5e1 / 0.72e2 * t124 + params_a_A0 + params_a_A1 * t140 / t146 / 0.576e3 + params_a_A2 * t152 / t159 / 0.331776e6 + params_a_A3 * t169 / (params_a_beta3 * t169 + 0.1e1)))
res = t107 + t179
