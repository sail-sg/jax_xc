...
t49 = t46 / t41 / r0
t50 = math.asinh(t49)
t63 = jnp.where(r0 <= p_a_dens_threshold, 0, 0.3e1 / 0.20e2 * t6 * t29 * t31 * (0.10e1 + 0.2e1 / 0.9e1 * t37 * t38 * s0 / t42 / t40 / (0.10e1 + t45 * t49 * t50)))
t65 = jnp.where(t11, t16, -t18)
t66 = jnp.where(t15, t12, t65)
t67 = 0.1e1 + t66
t69 = t67 ** (0.1e1 / 0.3e1)
t70 = t69 ** 2
t72 = jnp.where(t67 <= p_a_zeta_threshold, t25, t70 * t67)
t75 = r1 ** 2
t76 = r1 ** (0.1e1 / 0.3e1)
t77 = t76 ** 2
t80 = math.sqrt(s2)
t83 = t80 / t76 / r1
t84 = math.asinh(t83)
t97 = jnp.where(r1 <= p_a_dens_threshold, 0, 0.3e1 / 0.20e2 * t6 * t72 * t31 * (0.10e1 + 0.2e1 / 0.9e1 * t37 * t38 * s2 / t77 / t75 / (0.10e1 + t45 * t83 * t84)))
res = t63 + t97
