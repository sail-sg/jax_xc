...
t84 = lax_cond(r0 <= p_a_dens_threshold, 0, 0.3e1 / 0.20e2 * t6 * t29 * t31 * (t59 * t78 + t46 + 0.1e1))
...
t132 = lax_cond(r1 <= p_a_dens_threshold, 0, 0.3e1 / 0.20e2 * t6 * t93 * t31 * (t113 * t126 + t102 + 0.1e1))
res = t84 + t132
