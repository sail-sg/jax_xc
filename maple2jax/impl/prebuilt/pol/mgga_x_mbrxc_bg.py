...
t58 = abs(t57)
t61 = jnp.where(0.0e0 < t57, 0.50e-12, -0.50e-12)
t62 = jnp.where(t58 < 0.50e-12, t61, t57)
t63 = mbrxc_x(t62)
t65 = math.exp(t63 / 0.3e1)
t67 = math.exp(-t63)
t68 = t63 ** 2
t76 = (0.1e1 + t63) ** (0.1e1 / 0.3e1)
t82 = jnp.where(r0 <= p_a_dens_threshold, 0, -t22 * t23 * t29 * t31 * t65 * (0.8e1 - t67 * (t68 + 0.5e1 * t63 + 0.8e1)) / t63 / t76 / 0.64e2)
t84 = jnp.where(t6, t11, -t13)
t85 = jnp.where(t10, t7, t84)
t86 = 0.1e1 + t85
t88 = t86 ** (0.1e1 / 0.3e1)
t90 = jnp.where(t86 <= p_a_zeta_threshold, t19, t88 * t86)
t93 = r1 ** (0.1e1 / 0.3e1)
t94 = t93 ** 2
t99 = r1 ** 2
t104 = s2 ** 2
...
t112 = abs(t111)
t115 = jnp.where(0.0e0 < t111, 0.50e-12, -0.50e-12)
t116 = jnp.where(t112 < 0.50e-12, t115, t111)
t117 = mbrxc_x(t116)
t119 = math.exp(t117 / 0.3e1)
t121 = math.exp(-t117)
t122 = t117 ** 2
t130 = (0.1e1 + t117) ** (0.1e1 / 0.3e1)
t136 = jnp.where(r1 <= p_a_dens_threshold, 0, -t90 * t23 * t29 * t31 * t119 * (0.8e1 - t121 * (t122 + 0.5e1 * t117 + 0.8e1)) / t117 / t130 / 0.64e2)
res = t82 + t136
