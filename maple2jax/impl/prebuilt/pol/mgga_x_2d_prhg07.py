...
t40 = lax_cond(-0.9999999999e0 < t38, t38, -0.9999999999e0)
t41 = math.exp(-1)
t43 = scipy.special.lambertw(t40 * t41)
t46 = scipy.special.i0(t43 / 0.2e1 + 0.1e1 / 0.2e1)
t50 = lax_cond(r0 <= p_a_dens_threshold, 0, -math.pi * t22 * t26 * t46 / 0.8e1)
t52 = lax_cond(t6, t11, -t13)
t53 = lax_cond(t10, t7, t52)
t54 = 0.1e1 + t53
t56 = math.sqrt(t54)
t58 = lax_cond(t54 <= p_a_zeta_threshold, t19, t56 * t54)
t60 = r1 ** 2
t61 = 0.1e1 / t60
t70 = (l1 * t61 / 0.4e1 - tau1 * t61 + s2 / t60 / r1 / 0.8e1) * t37
t72 = lax_cond(-0.9999999999e0 < t70, t70, -0.9999999999e0)
t74 = scipy.special.lambertw(t72 * t41)
t77 = scipy.special.i0(t74 / 0.2e1 + 0.1e1 / 0.2e1)
t81 = lax_cond(r1 <= p_a_dens_threshold, 0, -math.pi * t58 * t26 * t77 / 0.8e1)
res = t50 + t81
