...
t37 = t33 / t34 / r0
t38 = math.asinh(t37)
t50 = jnp.where(r0 <= p_a_dens_threshold, 0, -0.2e1 / 0.3e1 * t3 * t24 * t28 * (0.1e1 + 0.26250000000000000000e-2 * t2 * s0 / t30 / r0 / (0.1e1 + 0.56e-1 * t37 * t38)))
t52 = jnp.where(t8, t13, -t15)
t53 = jnp.where(t12, t9, t52)
t54 = 0.1e1 + t53
t56 = math.sqrt(t54)
t58 = jnp.where(t54 <= p_a_zeta_threshold, t21, t56 * t54)
t61 = r1 ** 2
t64 = math.sqrt(s2)
t65 = math.sqrt(r1)
t68 = t64 / t65 / r1
t69 = math.asinh(t68)
t81 = jnp.where(r1 <= p_a_dens_threshold, 0, -0.2e1 / 0.3e1 * t3 * t58 * t28 * (0.1e1 + 0.26250000000000000000e-2 * t2 * s2 / t61 / r1 / (0.1e1 + 0.56e-1 * t68 * t69)))
res = t50 + t81
