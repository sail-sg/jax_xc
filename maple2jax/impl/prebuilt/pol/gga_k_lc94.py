...
t84 = lax_cond(r0 <= p_a_dens_threshold, 0, 0.3e1 / 0.20e2 * t6 * t29 * t31 * (0.1e1 + ((params_a_d * t48 + params_a_c) * t33 * t45 / 0.24e2 - t64) / (0.1e1 + t56 * t57 * t59 * params_a_a * t73 / 0.12e2 + t64)))
t86 = lax_cond(t11, t16, -t18)
t87 = lax_cond(t15, t12, t86)
t88 = 0.1e1 + t87
t90 = t88 ** (0.1e1 / 0.3e1)
t91 = t90 ** 2
t93 = lax_cond(t88 <= p_a_zeta_threshold, t25, t91 * t88)
t96 = r1 ** 2
t97 = r1 ** (0.1e1 / 0.3e1)
t98 = t97 ** 2
t101 = t38 * s2 / t98 / t96
...
t136 = lax_cond(r1 <= p_a_dens_threshold, 0, 0.3e1 / 0.20e2 * t6 * t93 * t31 * (0.1e1 + ((params_a_d * t104 + params_a_c) * t33 * t101 / 0.24e2 - t117) / (0.1e1 + t56 * t110 * t112 * params_a_a * t125 / 0.12e2 + t117)))
res = t84 + t136
