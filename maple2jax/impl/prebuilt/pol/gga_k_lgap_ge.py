...
t64 = t53 ** 2
t73 = jnp.where(r0 <= p_a_dens_threshold, 0, 0.3e1 / 0.20e2 * t6 * t29 * t31 * (0.1e1 + t36 * t39 * t40 / t42 / r0 / 0.12e2 + t49 * t51 * s0 / t54 / t53 / 0.24e2 + t62 * t40 * s0 / t64 / 0.48e2))
t75 = jnp.where(t11, t16, -t18)
t76 = jnp.where(t15, t12, t75)
t77 = 0.1e1 + t76
t79 = t77 ** (0.1e1 / 0.3e1)
t80 = t79 ** 2
t82 = jnp.where(t77 <= p_a_zeta_threshold, t25, t80 * t77)
t84 = math.sqrt(s2)
t86 = r1 ** (0.1e1 / 0.3e1)
t93 = r1 ** 2
t94 = t86 ** 2
t101 = t93 ** 2
t110 = jnp.where(r1 <= p_a_dens_threshold, 0, 0.3e1 / 0.20e2 * t6 * t82 * t31 * (0.1e1 + t36 * t39 * t84 / t86 / r1 / 0.12e2 + t49 * t51 * s2 / t94 / t93 / 0.24e2 + t62 * t84 * s2 / t101 / 0.48e2))
res = t73 + t110
