...
t77 = jnp.where(r0 <= p_a_dens_threshold, 0, 0.3e1 / 0.20e2 * t6 * t29 * t31 * (0.1e1 + params_a_kappa * (0.1e1 - t70)))
t79 = jnp.where(t11, t16, -t18)
t80 = jnp.where(t15, t12, t79)
t81 = 0.1e1 + t80
t83 = t81 ** (0.1e1 / 0.3e1)
t84 = t83 ** 2
t86 = jnp.where(t81 <= p_a_zeta_threshold, t25, t84 * t81)
t88 = math.sqrt(s2)
t90 = r1 ** (0.1e1 / 0.3e1)
t97 = r1 ** 2
t98 = t90 ** 2
...
t118 = jnp.where(r1 <= p_a_dens_threshold, 0, 0.3e1 / 0.20e2 * t6 * t86 * t31 * (0.1e1 + params_a_kappa * (0.1e1 - t111)))
res = t77 + t118
