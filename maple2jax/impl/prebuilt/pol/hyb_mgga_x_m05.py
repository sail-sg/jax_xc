...
t126 = jnp.where(r0 <= p_a_dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t26 * t29 * (0.18040e1 - 0.64641600e0 / (0.8040e0 + 0.91464571985215458336e-2 * t35 * s0 / t38 / t36)) * t121)
t128 = jnp.where(t10, t15, -t17)
t129 = jnp.where(t14, t11, t128)
t130 = 0.1e1 + t129
t132 = t130 ** (0.1e1 / 0.3e1)
t134 = jnp.where(t130 <= p_a_zeta_threshold, t23, t132 * t130)
t136 = r1 ** 2
t137 = r1 ** (0.1e1 / 0.3e1)
t138 = t137 ** 2
t150 = tau1 / t138 / r1
...
t211 = jnp.where(r1 <= p_a_dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t134 * t29 * (0.18040e1 - 0.64641600e0 / (0.8040e0 + 0.91464571985215458336e-2 * t35 * s2 / t138 / t136)) * t206)
res = t126 + t211
