...
t121 = jnp.where(t82 <= 0.25e1, 0.1e1 - 0.667e0 * t100 - 0.4445555e0 * t102 - 0.663086601049e0 * t104 + 0.1451297044490e1 * t106 - 0.887998041597e0 * t106 * t100 + 0.234528941479e0 * t106 * t102 - 0.23185843322e-1 * t106 * t104, -params_a_d * t119)
t127 = math.sqrt(0.3e1)
t129 = t46 / t31
t130 = math.sqrt(s0)
t135 = math.sqrt(t129 * t130 / t36 / r0)
t139 = math.exp(-0.98958000000000000000e1 * t127 / t135)
t144 = jnp.where(r0 <= p_a_dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t26 * t28 * ((0.1e1 + params_a_k1 * (0.1e1 - params_a_k1 / (params_a_k1 + 0.5e1 / 0.972e3 * t34 * t40 + t50 * t51 / t36 / t52 / r0 * t62 / 0.576e3 + t91))) * (0.1e1 - t121) + 0.1174e1 * t121) * (0.1e1 - t139))
t146 = jnp.where(t10, t15, -t17)
t147 = jnp.where(t14, t11, t146)
t148 = 0.1e1 + t147
t150 = t148 ** (0.1e1 / 0.3e1)
t152 = jnp.where(t148 <= p_a_zeta_threshold, t23, t150 * t148)
t154 = r1 ** 2
t155 = r1 ** (0.1e1 / 0.3e1)
t156 = t155 ** 2
...
t227 = jnp.where(t188 <= 0.25e1, 0.1e1 - 0.667e0 * t206 - 0.4445555e0 * t208 - 0.663086601049e0 * t210 + 0.1451297044490e1 * t212 - 0.887998041597e0 * t212 * t206 + 0.234528941479e0 * t212 * t208 - 0.23185843322e-1 * t212 * t210, -params_a_d * t225)
t233 = math.sqrt(s2)
t238 = math.sqrt(t129 * t233 / t155 / r1)
t242 = math.exp(-0.98958000000000000000e1 * t127 / t238)
t247 = jnp.where(r1 <= p_a_dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t152 * t28 * ((0.1e1 + params_a_k1 * (0.1e1 - params_a_k1 / (params_a_k1 + 0.5e1 / 0.972e3 * t34 * t159 + t50 * t162 / t155 / t163 / r1 * t172 / 0.576e3 + t197))) * (0.1e1 - t227) + 0.1174e1 * t227) * (0.1e1 - t242))
res = t144 + t247
