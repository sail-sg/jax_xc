...
t43 = t42 ** 2
t44 = 0.1e1 / t43
t52 = jnp.where(r0 <= p_a_dens_threshold, 0, 0.3e1 / 0.20e2 * t6 * t29 * t31 * (params_a_gamma + 0.5e1 / 0.72e2 * params_a_lambda * s0 / t36 / t34 * t39 * t44))
t54 = jnp.where(t11, t16, -t18)
t55 = jnp.where(t15, t12, t54)
t56 = 0.1e1 + t55
t58 = t56 ** (0.1e1 / 0.3e1)
t59 = t58 ** 2
t61 = jnp.where(t56 <= p_a_zeta_threshold, t25, t59 * t56)
t64 = r1 ** 2
t65 = r1 ** (0.1e1 / 0.3e1)
t66 = t65 ** 2
t77 = jnp.where(r1 <= p_a_dens_threshold, 0, 0.3e1 / 0.20e2 * t6 * t61 * t31 * (params_a_gamma + 0.5e1 / 0.72e2 * params_a_lambda * s2 / t66 / t64 * t39 * t44))
res = t52 + t77
