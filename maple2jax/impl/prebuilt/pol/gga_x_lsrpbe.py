...
t62 = jnp.where(r0 <= p_a_dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t26 * t27 * (0.1e1 + params_a_kappa * (0.1e1 - t46) - t49 * (0.1e1 - t55)))
...
t95 = jnp.where(r1 <= p_a_dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t70 * t27 * (0.1e1 + params_a_kappa * (0.1e1 - t81) - t49 * (0.1e1 - t88)))
res = t62 + t95
