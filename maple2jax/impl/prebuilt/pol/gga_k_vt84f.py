...
t99 = jnp.where(r0 <= p_a_dens_threshold, 0, 0.3e1 / 0.20e2 * t6 * t29 * t31 * t95)
t101 = jnp.where(t11, t16, -t18)
t102 = jnp.where(t15, t12, t101)
t103 = 0.1e1 + t102
t105 = t103 ** (0.1e1 / 0.3e1)
t106 = t105 ** 2
t108 = jnp.where(t103 <= p_a_zeta_threshold, t25, t106 * t103)
t110 = math.sqrt(s2)
t111 = r1 ** (0.1e1 / 0.3e1)
...
t159 = jnp.where(r1 <= p_a_dens_threshold, 0, 0.3e1 / 0.20e2 * t6 * t108 * t31 * t155)
res = t99 + t159
