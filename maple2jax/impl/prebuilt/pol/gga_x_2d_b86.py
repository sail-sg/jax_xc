...
t29 = r0 ** 2
t32 = s0 / t29 / r0
t42 = jnp.where(r0 <= p_a_dens_threshold, 0, -0.2e1 / 0.3e1 * t3 * t24 * t26 * t28 * (0.1e1 + 0.2105e-2 * t32) / (0.1e1 + 0.119e-3 * t32))
t44 = jnp.where(t8, t13, -t15)
t45 = jnp.where(t12, t9, t44)
t46 = 0.1e1 + t45
t48 = math.sqrt(t46)
t50 = jnp.where(t46 <= p_a_zeta_threshold, t21, t48 * t46)
t53 = r1 ** 2
t56 = s2 / t53 / r1
t66 = jnp.where(r1 <= p_a_dens_threshold, 0, -0.2e1 / 0.3e1 * t3 * t50 * t26 * t28 * (0.1e1 + 0.2105e-2 * t56) / (0.1e1 + 0.119e-3 * t56))
res = t42 + t66
