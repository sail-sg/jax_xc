...
t50 = t39 ** 2
t51 = t50 ** 2
t64 = jnp.where(r0 <= p_a_dens_threshold, 0, 0.3e1 / 0.20e2 * t6 * t29 * t31 * (0.1e1 + 0.5e1 / 0.648e3 * t38 * s0 / t41 / t39 / (0.1e1 + t46 * t47 * s0 / t51 / 0.2304e4)))
t66 = jnp.where(t11, t16, -t18)
t67 = jnp.where(t15, t12, t66)
t68 = 0.1e1 + t67
t70 = t68 ** (0.1e1 / 0.3e1)
t71 = t70 ** 2
t73 = jnp.where(t68 <= p_a_zeta_threshold, t25, t71 * t68)
t75 = r1 ** 2
t76 = r1 ** (0.1e1 / 0.3e1)
t77 = t76 ** 2
t81 = s2 ** 2
t84 = t75 ** 2
t85 = t84 ** 2
t98 = jnp.where(r1 <= p_a_dens_threshold, 0, 0.3e1 / 0.20e2 * t6 * t73 * t31 * (0.1e1 + 0.5e1 / 0.648e3 * t38 * s2 / t77 / t75 / (0.1e1 + t46 * t81 * s2 / t85 / 0.2304e4)))
res = t64 + t98
