...
t122 = jnp.where(r0 <= p_a_dens_threshold, 0, 0.3e1 / 0.20e2 * t6 * t29 * t31 * (t89 * t116 + t46))
t124 = jnp.where(t11, t16, -t18)
t125 = jnp.where(t15, t12, t124)
t126 = 0.1e1 + t125
t128 = t126 ** (0.1e1 / 0.3e1)
t129 = t128 ** 2
t131 = jnp.where(t126 <= p_a_zeta_threshold, t25, t129 * t126)
t133 = r1 ** 2
t134 = r1 ** (0.1e1 / 0.3e1)
t135 = t134 ** 2
...
t209 = jnp.where(r1 <= p_a_dens_threshold, 0, 0.3e1 / 0.20e2 * t6 * t131 * t31 * (t179 * t203 + t140))
res = t122 + t209
